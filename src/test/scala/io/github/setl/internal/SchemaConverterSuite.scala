...
class SchemaConverterSuite extends AnyFunSuite with Matchers {
  ...
  test("SchemaConverter should throw exception if column can't be found") {
    ...
    assertThrows[io.github.setl.exception.InvalidSchemaException](SchemaConverter.fromDF[TestOrder](df))
    ...
    assertThrows[io.github.setl.exception.InvalidSchemaException](SchemaConverter.fromDF[TestException3](df))
  }
