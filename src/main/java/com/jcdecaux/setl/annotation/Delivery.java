...
/**
 * The annotation @Delivery indicates {@link com.jcdecaux.setl.workflow.DeliverableDispatcher} that the current field
 * or method is marked as an input and it will be injected during the runtime by the DispatchManager.
 * <p>
 * If multiple {@link com.jcdecaux.setl.transformation.Deliverable} of the same type were found in the delivery pool of DispatchManager, then
