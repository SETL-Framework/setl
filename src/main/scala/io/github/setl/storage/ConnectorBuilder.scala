...
/**
 * ConnectorBuilder will build a [[io.github.setl.storage.connector.Connector]] object with the given
 * configuration.
 *
 * @param config either a [[com.typesafe.config.Config]] or a [[io.github.setl.config.Conf]] object
 */
...
class ConnectorBuilder(val config: Either[Config, Conf]) extends Builder[Connector] {
   ...
   * configuration.
   *
   * @param conf a [[io.github.setl.config.Conf]] object
   */
  ...
  /**
   * Build a connector from either a [[com.typesafe.config.Config]] or a [[io.github.setl.config.Conf]] object.
   *
   * the `config` object must have a key `storage` and the parameters corresponding to the storage
   *
   * @param config either a [[com.typesafe.config.Config]] or a [[io.github.setl.config.Conf]] object
   * @return [[io.github.setl.storage.connector.Connector]] a connector object
   */
