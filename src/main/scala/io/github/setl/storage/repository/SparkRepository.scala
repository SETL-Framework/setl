...
import io.github.setl.enums.{Storage, ValueType}
import io.github.setl.exception.{InvalidConnectorException, UnknownException}
import io.github.setl.internal._
import io.github.setl.storage.Condition
import io.github.setl.storage.connector.{Connector, FileConnector}
...
class SparkRepository[DataType: TypeTag] extends Repository[Dataset[DataType]] with Logging with HasSparkSession {
   ...
   *
   * @param connector [[io.github.setl.storage.connector.Connector]] an user defined connector
   * @return
   */
   ...
   *
   * @return a [[io.github.setl.storage.connector.Connector]] object
   */
  ...
  private[this] def findDataFrameBy(conditions: Set[Condition]): DataFrame = {
    import io.github.setl.util.FilterImplicits.ConditionsToRequest
   ...
   *
   * @param conditions Set of [[io.github.setl.storage.Condition]]
   * @return
   */
