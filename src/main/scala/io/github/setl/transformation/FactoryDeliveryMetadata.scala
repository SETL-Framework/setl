...
import io.github.setl.annotation.{Delivery, InterfaceStability}
...
private[setl] object FactoryDeliveryMetadata {
   ...
   */
  class Builder extends io.github.setl.Builder[Iterable[FactoryDeliveryMetadata]] {
  ...
  /**
   * DeliverySetterMetadata Builder will create a [[io.github.setl.transformation.FactoryDeliveryMetadata]]
