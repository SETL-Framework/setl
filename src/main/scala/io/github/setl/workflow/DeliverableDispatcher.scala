...
import io.github.setl.internal.{HasRegistry, Logging}
import io.github.setl.storage.repository.SparkRepository
import io.github.setl.transformation.{Deliverable, Factory, FactoryDeliveryMetadata}
 ...
 * It can:
 * <ul>
 * <li>collect a [[io.github.setl.transformation.Deliverable]]
 * from a [[io.github.setl.transformation.Factory]]</li>
 * <li>find the right [[io.github.setl.transformation.Deliverable]]
 * from its pool and send it to a [[io.github.setl.transformation.Factory]]</li>
 * </ul>
 */
...
private[setl] class DeliverableDispatcher extends Logging
   ...
   * @return a string like io.github.setl.storage.repository.SparkRepository[T]
   */
