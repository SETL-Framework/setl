...
import io.github.setl.internal.{HasDescription, Logging}
import io.github.setl.transformation.{Factory, FactoryInput, FactoryOutput}

/**
 * PipelineInspector will inspect a given [[io.github.setl.workflow.Pipeline]] and create a
