 ...
 * [[io.github.setl.internal.Identifiable]] object already
...
trait HasRegistry[T <: Identifiable] {
   ...
   *
   * @param item an object that inherit [[io.github.setl.internal.Identifiable]]
   ...
   *
   * @param items an [[io.github.setl.internal.Identifiable]] object
   */
