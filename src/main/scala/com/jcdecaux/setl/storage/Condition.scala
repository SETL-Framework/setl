...
import com.jcdecaux.setl.util.DateUtils
import org.apache.spark.sql.Column

/**
 * Condition is used by [[com.jcdecaux.setl.storage.repository.Repository]] to find data
 *
...
case class Condition(key: String, operator: String, value: Option[String], valueType: ValueType) {
  ...
  /**
   * Convert a [[com.jcdecaux.setl.storage.Condition]] object to a spark SQL query string
   *
